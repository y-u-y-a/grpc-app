...
type Emproyee struct {
	...
	//	*Emproyee_Text
	//	*Emproyee_Video
	Profile isEmproyee_Profile `protobuf_oneof:"profile"`
}

func (x *Emproyee) Reset() {
	*x = Emproyee{}
...
func (x *Emproyee) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Emproyee) ProtoMessage() {}

func (x *Emproyee) ProtoReflect() protoreflect.Message {
	mi := &file_proto_employee_proto_msgTypes[0]
...
// Deprecated: Use Emproyee.ProtoReflect.Descriptor instead.
func (*Emproyee) Descriptor() ([]byte, []int) {
	return file_proto_employee_proto_rawDescGZIP(), []int{0}
}

func (x *Emproyee) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *Emproyee) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *Emproyee) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *Emproyee) GetOccupation() Occupation {
	if x != nil {
		return x.Occupation
	}
...
func (x *Emproyee) GetPhoneNumber() []string {
	if x != nil {
...
func (x *Emproyee) GetProject() map[string]*Company_Project {
	if x != nil {
		return x.Project
	}
	return nil
...
func (m *Emproyee) GetProfile() isEmproyee_Profile {
	if m != nil {
		return m.Profile
	}
	return nil
...
func (x *Emproyee) GetText() string {
	if x, ok := x.GetProfile().(*Emproyee_Text); ok {
		return x.Text
	}
	return ""
}

func (x *Emproyee) GetVideo() *Video {
	if x, ok := x.GetProfile().(*Emproyee_Video); ok {
		return x.Video
	}
	return nil
}

type isEmproyee_Profile interface {
	isEmproyee_Profile()
}

type Emproyee_Text struct {
	Text string `protobuf:"bytes,7,opt,name=text,proto3,oneof"`
}

type Emproyee_Video struct {
	Video *Video `protobuf:"bytes,8,opt,name=video,proto3,oneof"`
}

func (*Emproyee_Text) isEmproyee_Profile() {}

func (*Emproyee_Video) isEmproyee_Profile() {}
...
var file_proto_employee_proto_rawDesc = []byte{
	...
	0x22, 0xf9, 0x02, 0x0a, 0x08, 0x45, 0x6d, 0x70, 0x72, 0x6f, 0x79, 0x65, 0x65, 0x12, 0x0e, 0x0a,
	...
	0x72, 0x6f, 0x79, 0x65, 0x65, 0x2e, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x45, 0x6e, 0x74,
	...
	0x01, 0x42, 0x09, 0x0a, 0x07, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x22, 0x07, 0x0a, 0x05,
	0x56, 0x69, 0x64, 0x65, 0x6f, 0x22, 0x14, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x6e, 0x79,
	0x1a, 0x09, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x2a, 0x4d, 0x0a, 0x0a, 0x4f,
...
var file_proto_employee_proto_goTypes = []interface{}{
	...
	(*Emproyee)(nil),        // 1: employee.Emproyee
	(*Video)(nil),           // 2: employee.Video
	(*Company)(nil),         // 3: employee.Company
	nil,                     // 4: employee.Emproyee.ProjectEntry
	(*Company_Project)(nil), // 5: employee.Company.Project
}
var file_proto_employee_proto_depIdxs = []int32{
	0, // 0: employee.Emproyee.occupation:type_name -> employee.Occupation
	4, // 1: employee.Emproyee.project:type_name -> employee.Emproyee.ProjectEntry
	2, // 2: employee.Emproyee.video:type_name -> employee.Video
	5, // 3: employee.Emproyee.ProjectEntry.value:type_name -> employee.Company.Project
